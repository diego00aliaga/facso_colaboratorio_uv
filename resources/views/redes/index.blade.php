			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-6 col-xl-4 mb-4">
					...
					<div class="white z-depth-1 py-3 px-5 text-center redcolab">
						...
						<a class="btn bg-rosa mt-4" href="https://www.uct.cl/facultades/facultad-ciencias-sociales-y-humanidades/" target="_blank">Más información<i class="fal fa-link fa-lg ms-2"></i></a>
					</div>
				</div>
				<div class="col-lg-6 col-xl-4 mb-4">
					<div class="white z-depth-1 py-3 px-4 text-center redcolab">
