    ...
    <div class="container-fluid py-5">
      <div class="row align-items-end justify-content-between">
        ...
        <div class="col-lg-4 col-xl-3 text-center py-3">
          ...
          <p class="mb-0 tx-chico">Hontaneda 2653, 2341369 <br>Valparaíso, Chile<a class="ms-2 azul" href="https://maps.app.goo.gl/siNqDVuYPGi2Mrzq9" target="_blank" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Google maps"><i class="fas fa-map-marker-alt fa-lg"></i><span class="sr-only">Ir a Google Maps</span></a></p>
        </div>
        <div class="col-lg-4 col-xl-3 text-center py-3">
