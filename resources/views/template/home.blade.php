    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item">
                    <a class="nav-link{{ request()->is('home','resultados') ? ' active' : '' }}" href="{{ route('home') }}">Buscador</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link{{ request()->is('sobre') ? ' active' : '' }}" href="{{ route('sobre') }}">Sobre el colaboratorio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link{{ request()->is('investigadores') ? ' active' : '' }}" href="{{ route('researcher.index') }}">Investigadoras/es</a>
                </li>
                <li class="nav-item">
...
<section class="grey lighten-3">
    <form class="container py-5">
        <div class="row justify-content-center align-items-center flex-column-reverse flex-md-row">
            <div class="col-lg-4 col-xxl-4 text-center pt-4 pt-md-0">
    ...
    <div class="container-fluid py-5">
        <div class="row align-items-end justify-content-between">
            <div class="col-lg-4 col-xl-3 text-center py-3">
                <img id="logoFooter" class="img-fluid" src="{{ asset('assets/images/logo_colaboratorio_blanco.png') }}" alt="Colaboratorio" width="250">
                <div class="pt-2">
            ...
            <div class="col-lg-4 col-xl-3 text-center py-3">
                <img id="logoFooter" class="img-fluid" src="{{ asset('assets/images/logo-facso_investiga-white.png') }}" alt="Logo FACSO abierta" width="250">
            </div>
            <div class="col-lg-4 col-xl-3 text-center py-3">
