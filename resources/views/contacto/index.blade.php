    ...
    <div class="container pb-5">
        <div class="row justify-content-center">
            <div class="col-md-9 text-center pb-4">
                <img class="img-fluid mb-4" src="{{ asset('assets/images/test5.png') }}" width="500" id="test5">
        ...
        <div class="row">
            <div class="col-md-9 mb-md-0 mb-5">
                <form id="contact-form" name="contact-form" action="{{ route('contacto.send') }}" method="POST">
					@csrf
                    <div class="row">
                        <div class="col-md-6">
